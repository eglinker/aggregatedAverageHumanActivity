...
The tidy data set is generated by transforming the raw data set using R language script in named run_analysis.R, this script is included I this repo. The output file will be named **tidydata.txt**.    
