...
The tidy data set is generated by transforming the raw data set using R language script named **run_analysis.R**, this script is included in this repo.  The output file will be named tidydata.txt.  See code book for tidydata.txt file details.
